...
file=pathlib.Path('Daftar Pemesan Kamar Hotel.xlsx')
if file.exists():
    pass
else:
    file=Workbook()
    ...
    file.save('Daftar Pemesan Kamar Hotel.xlsx')
...
def submit():
    ...
    else: file=openpyxl.load_workbook('Daftar Pemesan Kamar Hotel.xlsx')
    sheet=file.active
    ...
    file.save(r'Daftar Pemesan Kamar Hotel.xlsx')
...
icon_image=PhotoImage(file="logologo.png")
